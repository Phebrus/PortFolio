        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <nav className="flex flex-col space-y-2">
              ...
              <a href="/Saba-Sherazadishvili-Resume.pdf" target="_blank" rel="noopener noreferrer" className="text-gray-600 dark:text-gray-400 hover:text-primary dark:hover:text-primary transition-colors">
                Resume
              </a>
            </nav>
          </div>
